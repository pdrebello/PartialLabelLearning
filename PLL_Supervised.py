...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan  4 11:19:38 2021
...
for filename in datasets:
    ...
    for fold_no in range(k):
        ...
        best_val = 0
        result_filename = "results/"+filename+"/"+str("supervised")+"/results/"+str(fold_no)+"_out.txt"
        result_log_filename = "results/"+filename+"/"+str("supervised")+"/logs/"+str(fold_no)+"_log.csv"
        model_filename = "results/"+filename+"/"+str("supervised")+"/models/"+str(fold_no)+"_best.pth"
        ...
        for epoch in range(1, n_epochs + 1):
          ...
          if((epoch%10==0) and (epoch>0)):
              e_model_filename = "results/"+filename+"/"+str("supervised")+"/models/"+str(fold_no)+"_"+str(epoch)+".pth"
        ...
        with open(result_log_filename,"w", newline='') as file:
            ...
            writer.writerow(["train_count", "train_acc", "test_count", "test_acc"])
