    ...
    for tech in ["sample","select"]:
        for input_x in [True]:
            ...
            #for fold_no in [0]:  
                ...
                best_val = 0
                result_filename = "results/10012020/"+filename+"/SelectR_"+str(tech)+"_"+str(input_x)+"/results/"+str(fold_no)+"_out.txt"
                result_log_filename = "results/10012020/"+filename+"/SelectR_"+str(tech)+"_"+str(input_x)+"/logs/"+str(fold_no)+"_log.csv"
                model_filename = "results/10012020/"+filename+"/SelectR_"+str(tech)+"_"+str(input_x)+"/models/"+str(fold_no)+"_best.pth"
                ...
                for epoch in range(1, n_epochs + 1):
                  ...
                  if((epoch%10==0) and (epoch>0)):
                      e_model_filename = "results/10012020/"+filename+"/SelectR_"+str(tech)+"_"+str(input_x)+"/models/"+str(fold_no)+"_"+str(epoch)+".pth"
